...
public class TrialAccountConstants {
    ...
    public static final String TRIAL_ACCOUNT_PERIOD = "trial.account.period";
    public static final String TRIAL_ACCOUNT_EXPIRY_ENABLED = "trial.account.expiry.enabled";


    public static final String TRIAL_ACCOUNT_SUSPENSION_TRIGGER_TIME = "trial.account.expiry.trigger.time";
